...
public:
    ...
    virtual std::vector<std::pair<Position,Move_type>> calculate_possible_moves(Piece*[8][8]) const = 0;
...
public:
    ...
    std::vector<std::pair<Position,Move_type>> calculate_possible_moves(Piece* board[8][8]) const override;
};
